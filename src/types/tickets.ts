...
export const STATUS_TICKET_BADGE_CLASSES: Record<StatusTicket, string> = {
  aberto: 'bg-blue-500/15 text-blue-600 border-blue-500/30 dark:text-blue-400',
  em_andamento: 'bg-amber-500/15 text-amber-600 border-amber-500/30 dark:text-amber-400',
...
export const PRIORIDADE_TICKET_BADGE_CLASSES: Record<PrioridadeTicket, string> = {
  ...
  media: 'bg-amber-500/15 text-amber-600 border-amber-500/30 dark:text-amber-400',
  alta: 'bg-orange-500/15 text-orange-600 border-orange-500/30 dark:text-orange-400',
  urgente: 'bg-red-500/15 text-red-600 border-red-500/30 dark:text-red-400',
};
