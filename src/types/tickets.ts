...
export const STATUS_TICKET_BADGE_CLASSES: Record<StatusTicket, string> = {
  ...
  em_andamento: 'bg-amber-500/10 text-amber-700 border-amber-500/30',
  aguardando_cliente: 'bg-purple-500/15 text-purple-600 border-purple-500/30',
  resolvido: 'bg-green-500/15 text-green-600 border-green-500/30',
...
export const PRIORIDADE_TICKET_BADGE_CLASSES: Record<PrioridadeTicket, string> = {
  ...
  urgente: 'bg-red-500/10 text-red-700 border-red-500/30',
};
