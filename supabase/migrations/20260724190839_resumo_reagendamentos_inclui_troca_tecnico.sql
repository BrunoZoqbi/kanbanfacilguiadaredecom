-- Adiciona 'troca_tecnico' ao breakdown por_motivo — sem isso, o gráfico
-- "Distribuição por Motivo de Reagendamento" sempre mostraria 0 para esse
-- motivo mesmo com dados reais, já que ele itera sobre todas as chaves de
-- REAGENDAMENTO_MOTIVO_LABELS no frontend.
    ...
    (
      SELECT
        ...
        jsonb_build_object(
          ...
          'troca_tecnico', count(*) FILTER (WHERE reagendamento_motivo = 'troca_tecnico'),
