...
- A ordem dos itens do menu em AppLayout.tsx é: Notificações, Dashboard (admin only), Minhas Tarefas, Kanban, Calendário, Prospecção (admin+gestor_comercial), Scripts, Tickets, Estoque, Gerenciar (admin only), Ajuda. Manter essa ordem ao adicionar novos itens.
